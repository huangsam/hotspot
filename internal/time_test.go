...
func TestCalculateDaysBetween(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedDays: 0,
			description:  "Age is exactly 24 hours, falls within the [24h, 36h) forgiveness window, should return 0 days.",
		},
		{
			name:         "mid-forgiveness window (30 hours)",
			duration:     30 * time.Hour,
			expectedDays: 0,
			description:  "Age is 30 hours, falls within the [24h, 36h) forgiveness window, should return 0 days.",
		},
		{
			name:         "just under 36 hours (forgiveness end)",
			duration:     36*time.Hour - time.Second,
			expectedDays: 0,
			description:  "Age is just under 36 hours, falls within the [24h, 36h) forgiveness window, should return 0 days.",
		},
		{
			name:         "exactly 36 hours (boundary)",
			duration:     36 * time.Hour,
			expectedDays: 1,
			description:  "Age is exactly 36 hours, hits the boundary, days = 1.",
		},
		{
			name:         "one second over 36 hours",
			duration:     36*time.Hour + time.Second,
			expectedDays: 1,
			description:  "Age is one second over 36 hours, days = 1.",
		},
		{
